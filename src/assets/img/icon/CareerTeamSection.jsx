    ...
    <section className="team pt-130 pb-130" style={{overflow:"hidden"}}>
      <div className="container">
        <div className="sec-title--two text-center mb-50">
          ...
          >
            <img src="assets/img/icon/cp-icon.svg" alt="" />
            Open Positions
          </div>
          <h2
          ...
          <div className="col-lg-12">
            <div className="cp-team-wrap grid" style={{ position: "relative", height: "1071.68px" }}>
              {[
                ...
                <div key={index} className={`cp-team-item grid-item ${job.categories}`} style={{ position: "absolute", left: "0%", top: `${index * 178}px` }}>
                  <div className="xb-item--inner ul_li_between">
                    <div className="xb-item--content">
                      <h3 className="xb-item--title">
                        <a href={job.link} style={{textDecoration:"none"}}>{job.title}</a>
                      </h3>
                      <div className="xb-item--holder ul_li">
                        <span className="xb-item--meta">
                          <img src="assets/img/icon/loc-icon.svg" alt="" />
                          {job.location}
                        </span>
                        <span className="xb-item--meta">
                          <img src="assets/img/icon/clock-icon.svg" alt="" />
                          {job.time || "Full time"}
                        </span>
                      </div>
                    </div>
