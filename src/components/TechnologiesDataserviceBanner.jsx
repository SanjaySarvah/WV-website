...
import dataservicebanner from "../assets/img/hero/dataanalytics_bi.webp";

const TechnologiesDataserviceBanner = () => {
  return (
    <div>
       <section
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="xb-hero">
                ...
                >
                  Unlock Growth with Our Data <br />
    ...
    export default TechnologiesDataserviceBanner;