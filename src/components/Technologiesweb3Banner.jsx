...
import web3img from "../assets/img/hero/web3.o.png";

const Technologiesweb3Banner = () => {
  return (
    <div>
      <section
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="xb-hero">
                ...
                >
                  With us, you can stay ahead of the curve in the world of web3
    ...
    export default Technologiesweb3Banner;