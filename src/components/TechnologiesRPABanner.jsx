...
import rpahomeimg from "../assets/img/hero/RPA-Home-page.png"
const TechnologiesRPABanner = () => {
  return (
    <div>
        <section
            ...
            <div className="col-lg-6">
              <div className="xb-hero">
                <h1 className="xb-item--title wow fadeInUp" data-wow-duration="600ms">
                  ROBOTIC PROCESS AUTOMATION SERVICES <span>we’ll automate it.</span>
                </h1>
    ...
    export default TechnologiesRPABanner;