...
import manufacturebg from '../assets/img/hero/it-solutions-for-manufacturing-cover-picture.svg';

const IndustriesManufacturingBanner = () => {
  return (
    <div>
         <section
            ...
            <div className="col-lg-6">
              <div className="xb-hero">
                <h1 className="xb-item--title wow fadeInUp" data-wow-duration="600ms">
                  ...
                  <span> with reduced manufacturing cost.</span>
                </h1>
            ...
            <div className="col-lg-6">
              <div className="hero-right_img pos-rel">
                <img
                  ...
                  data-wow-duration="600ms"
                  src={manufacturebg}
                  alt="Industrial Manufacturing Solution"
                />
              </div>
            </div>
          </div>
...
export default IndustriesManufacturingBanner;
