...
import healthcarebgImage from '../assets/img/hero/helthcare.webp';

const IndustriesHealthcareBanner = () => {
  return (
    <div>
<section
...
<div className="container">
      ...
      <div className="col-lg-6">
        <div className="xb-hero">
          <h1 className="xb-item--title wow fadeInUp" data-wow-duration="600ms">
            Delivering Top-Grade Healthcare Solutions <br />
          ...
          >
            <a href="contact-us.html" className="thm-btn thm-btn--aso thm-btn--aso_yellow">
  ...
  <div className="banner-scroll-down active">
    ...
    export default IndustriesHealthcareBanner;