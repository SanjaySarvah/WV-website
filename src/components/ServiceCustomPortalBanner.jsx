...
import heroImage from '../assets/img/hero/cw.png';
const ServiceCustomPortalBanner = () => {
  return (
    <div>
         <section
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="xb-hero">
                ...
                >
                  <a href="/contact-us" className="thm-btn thm-btn--aso thm-btn--aso_yellow">
...
export default ServiceCustomPortalBanner;
