...
import mlbannerimg from "../assets/img/hero/ai-machine-learning.png"
const TechnologiesMachineLearningBanner = () => {
  return (
    <div>
      <section
            ...
            <div className="col-lg-6">
              <div className="xb-hero">
                <h1 className="xb-item--title wow fadeInUp" data-wow-duration="600ms">
                  EXQUISITE MACHINE LEARNING SERVICES <br />
    ...
    export default TechnologiesMachineLearningBanner;